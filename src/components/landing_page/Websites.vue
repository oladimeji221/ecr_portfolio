<template>
  ...
  const allSlides = [
    { category: 'Ngo', image: '/src/assets/img/websites/oluebubefoundation.png', alt: 'oluebubechukwufoundation', title: '', description: '', cta1: 'Request Quote', cta2: 'Learn More' },
    { category: 'Ngo', image: '/src/assets/img/websites/buberio.png', alt: 'buberio', title: '', description: '', cta1: 'Request Quote', cta2: 'Learn More' },
    { category: 'Ngo', image: '/src/assets/img/websites/nwgm.png', alt: 'nwgm', title: '', description: '', cta1: 'Request Quote', cta2: 'Learn More' },
    { category: 'Ngo', image: '/src/assets/img/websites/familyvaluestv.png', alt: 'familyvaluestv', title: '', description: '', cta1: 'Request Quote', cta2: 'Learn More' },
    { category: 'Ngo', image: '/src/assets/img/websites/annieshopefoundation.png', alt: 'annieshopefoundation', title: '', description: '', cta1: 'Request Quote', cta2: 'Learn More' },

    { category: 'Business', image: '/src/assets/img/websites/pumeco.png', alt: 'pumeco', title: '', description: '', cta1: 'Request Quote', cta2: 'Learn More' },
    { category: 'Business', image: '/src/assets/img/websites/checkartisan.png', alt: 'checkartisan', title: '', description: '', cta1: 'Request Quote', cta2: 'Learn More' },

    { category: 'Personal', image: '/src/assets/img/websites/oluebubechukwu.png', alt: 'oluebuebechukwu', title: '', description: '', cta1: 'Request Quote', cta2: 'Learn More' },
    { category: 'Hospitality', image: '/src/assets/img/websites/telarcove.png', alt: 'telarcove', title: '', description: '', cta1: 'Request Quote', cta2: 'Learn More' },
    { category: 'Hospitality', image: '/src/assets/img/websites/rapha.png', alt: 'rapha', title: '', description: '', cta1: 'Request Quote', cta2: 'Learn More' },
    { category: 'Hospitality', image: '/src/assets/img/websites/bookamia.png', alt: 'bookamia', title: '', description: '', cta1: 'Request Quote', cta2: 'Learn More' },
    { category: 'Medical', image: '/src/assets/img/websites/gotovet.png', alt: 'gotovet', title: '', description: '', cta1: 'Request Quote', cta2: 'Learn More' },
    { category: 'Medical', image: '/src/assets/img/websites/qcm.png', alt: 'qcm transport', title: '', description: '', cta1: 'Request Quote', cta2: 'Learn More' },
    { category: 'Medical', image: '/src/assets/img/websites/qikpharma.png', alt: 'qikpharma', title: '', description: '', cta1: 'Request Quote', cta2: 'Learn More' },
