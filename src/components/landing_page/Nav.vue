      ...
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            ...
            <img class="h-8 w-auto" src="/src/assets/img/logo.png" alt="" />
          </a>
        </div>
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="https://www.ecr-ts.com" class="text-sm/6 font-semibold text-gray-900">Visit Site <span aria-hidden="true">&rarr;</span></a>
        </div>
      </nav>
      <!-- Mobile menu, show/hide based on menu open state. -->
      <Dialog as="div" :open="mobileMenuOpen" class="lg:hidden" @close="mobileMenuOpen = false">
        ...
        <DialogPanel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white p-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              ...
              <div class="py-6">
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Visit Site </a>
              </div>
            </div>
          </div>
        </DialogPanel>
